...
def parse_args():
    ...
    # src/data/Sports_and_Outdoors.txt
    ...
    parser.add_argument("--all_sequence_output", default=0, type=int)
    ...
    # model args
    parser.add_argument("--model_type", default='lowarec', type=str)
    ...
    parser.add_argument("--attention_probs_dropout_prob", default=0.2, type=float)
    parser.add_argument("--hidden_dropout_prob", default=0.2, type=float)
    parser.add_argument("--initializer_range", default=0.02, type=float)

    args, _ = parser.parse_known_args()

    if args.model_type.lower() == 'lowarec':

        parser.add_argument("--proj_n_heads", default=4, type=int)
        parser.add_argument("--proj_dropout", default=0.5, type=float)
        parser.add_argument("--c", default=9, type=int, help="hyperparamete c")
        parser.add_argument("--alpha", default=0.3, type=float, help = "hyperparamete alpha")
        parser.add_argument("--dim_proj", default=10, type=int, help = "hyperparamete P")  # hyperparamete P


    elif args.model_type.lower() == 'bsarec':
        parser.add_argument("--c", default=3, type=int)
        parser.add_argument("--alpha", default=0.9, type=float)
    elif args.model_type.lower() == 'lightsans':
        parser.add_argument("--k_interests", default=5, type=int)
