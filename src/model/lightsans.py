...
"""
[Paper]
Author: Xinyan Fan et al. 
Title: "Lighter and Better: Low-Rank Decomposed Self-Attention Networks for Next-Item Recommendation."
Conference: Proceedings of the 44th International ACM SIGIR Conference on Research and Development in Information Retrieval,2021
...
class LightSANs(SequentialRecModel):
    def __init__(self, args):
        super(LightSANs, self).__init__(args)

        # load parameters info
        self.n_layers = args.num_hidden_layers
        self.n_heads = args.num_attention_heads
        self.k_interests = args.k_interests
    ...
    def forward(self, input_ids, user_ids=None, all_sequence_output=False):
        item_emb, position_embedding = self.embedding_layer(input_ids)
        ...
        if all_sequence_output:
            sequence_output = trm_output
        else:
            sequence_output = trm_output[-1]
